...
import SungJinWoo.modules.sql.welcome_sql as sql
...
from SungJinWoo.modules.helper_funcs.misc import build_keyboard, revert_buttons
from SungJinWoo.modules.helper_funcs.msg_types import get_welcome_type
from SungJinWoo.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from SungJinWoo.modules.log_channel import loggable
from SungJinWoo.modules.sql.global_bans_sql import is_user_gbanned
...
import SungJinWoo.modules.sql.log_channel_sql as logsql
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Huh! An A-Rank Hunter just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
