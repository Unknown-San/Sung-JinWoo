...
from SungJinWoo.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@SungJinWoocmd(command="antichannelmode", group=100)
...
@SungJinWoomsg(Filters.chat_type.groups, group=110)
