...
import SungJinWoo.modules.sql.userinfo_sql as sql
from SungJinWoo import DEV_USERS
...
@SungJinWoocmd(command='me', pass_args=True)
...
@SungJinWoocmd(command='bio', pass_args=True)
def about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if (
            ...
            message.reply_text(
                "I only trust Monarch or A-Rank Hunters to set my bio."
            )
            return
